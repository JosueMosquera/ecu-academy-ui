pipeline {
    ...
    stages {
        ...
        stage("Despliegue"){
            ...
            steps{
                sh 'docker build -f devops/Dockerfile -t academy-front:latest .'
                sh 'docker stack rm academy-ui'
                sh 'docker stack deploy -c devops/stack.yml academy-ui'
            }    
        }
